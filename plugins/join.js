...
let kakashi = "https://telegra.ph/file/823c9bf42a201e6d3631d.mp4"
...
'kakshi'*${conn.user.name}* is a whatsapp bot built with Nodejs, *${conn.user.name}* invited by @${m.sender.split`@`[0]}
