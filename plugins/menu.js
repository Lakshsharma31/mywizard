...
└─────────────────⸙ \n\ ______`
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch("https://telegra.ph/file/6d2924f9a944388e00080.jpg")).buffer(), text.trim(), '𝕊𝕒𝕤𝕦𝕜𝕖 𝟚𝟘𝟚𝟚', 'Owner Bot', ',owner', 'All Commands', '.? all', m)
  } catch (e) {
