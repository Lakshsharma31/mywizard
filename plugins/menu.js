...
└─────────────────⸙ \n\ ______`
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch("https://telegra.ph/file/bb33e3627b643f617c043.jpg")).buffer(), text.trim(), '© nezuko ©', 'Owner Bot', ',owner', 'All Commands', '.? all', m)
  } catch (e) {
